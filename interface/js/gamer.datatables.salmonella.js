    ...
    driver.defineSteps([
        {
            ...
            popover: {
                ...
                <br/><b>Click \"next\" if you are ready to start the tutorial</b> \
                <br/><b>Click \"previous\" to see the previous tips</b> \
                <br/><b>Click \"quit\" to exit from tutorial</b>",
                position: 'left'
            }
        },
        {
            ...
            popover: {
                title: 'You are in the Salmonella genomes workspace for the tutorial',
        ...
        },
        {
            ...
            popover: {
                ...
                description: "<b>In this section, you can:</b> \
                <br\><br\>-Select all strains ids from the table, \
                ...
                <br\><br\>-Set the number of row per page, \
        ...
        },
        {
            ...
            popover: {
                title: 'Search box',
                description: "In this section, you can search information in every columns of this table. \
                At every search, it will be filtered dynamically. <br\> \
        ...
        },
        {
            ...
            popover: {
                ...
                description: "In this menu, you can access to the following features: \
                <br/><b>(click \"next\" to see!)</b>",
                position: 'right'
            }
        },
        {
        ...
        },
        {
            ...
            popover: {
                title: 'Table pages',
                description: "Notice you can also browse dynamincally this table, page per page" ,
                position: 'left'
            }
        },
        {
            ...
            popover: {
                title: 'Any bug? Some requests?',
                description: "Contact us using this form, we'll reply as soon as possible",
                position: 'top'
            }
        },
        {
        ...
        },
        {
            element: '#rowtutorial',
            popover: {
                title: 'You\'re able now to start the download',
                description: "You can <b>also</b>: \
                <br\><br\>-Copy the selected ids to your clipboard, \
                <br\><br\>-Export them in a Excel or a Pdf file, \
                <br\><br\>-Show or hide specific colums, \
                <br\><br\>-Set the number of row per page, \
                <br\><br\><br\><h2>Voila,</h2><b>you can now download your files, test the other features, or just close this tutorial :-)</b>" ,
                position: 'right'
            }
        }
    ]);
