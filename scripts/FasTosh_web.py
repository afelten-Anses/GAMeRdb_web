...
def get_parser():
	...
	parser.add_argument('-u', action="store", dest='uuid', 
						type=str, required=True,
						help='path of results directory (REQUIRED)')

	parser.add_argument('-o', action="store", dest='output', 
						type=str, default='output', help='output tsv matrix name (default:output)')
	...
	parser.add_argument('-k', action="store", dest='kmer_size', 
						type=int, default='15', help='k-mer size (1-32) (default:15)')
	...
	parser.add_argument('-e', action="store", dest='OUTPUT',
						type=str, default='output', help='output newick tree name (default:output)')    
	...
	parser.add_argument('--nbKmerDiff', dest='nbKmerDiff', action='store_true',
                     help='use the number of different kmer as distance instead of mash distance (defaut:False)', default=False)
...
def make_dist_tab(fasta_querie, fasta_targets, nbThreads, mashDist, dir_name):
...
def mash_dist_loop(sketch_files, nbThreads, mashDist, dir_name):
